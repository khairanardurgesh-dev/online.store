            ...
            {steps.map((step, index) => (
              ...
              >
                ...
                <motion.div
                  ...
                  animate={{ scale: 1 }}
                  transition={{ delay: 0.2, duration: 0.3 }}
                  className={`absolute -top-4 -left-4 w-8 h-8 bg-${step.color}-600 text-white rounded-full flex items-center justify-center font-bold text-lg`}
                >
                  {step.number}
                </motion.div>
                ...
                {/* Content */}
                <div className="ml-12">
                  <div className={`bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border-2 border-${step.color}-200`}>
